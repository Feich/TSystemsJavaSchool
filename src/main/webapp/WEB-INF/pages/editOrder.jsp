...
<div class="addCargoClass">
    <div class="addCargoForm">
        <br>
        <form action = "/addCargo" method = "POST" class="cargoForm" id="cargoForm">
        ...
        <form action="/addRoutePoint" method = "POST" class="addShipmentPoint" id="addShipmentPoint">
        ...
        <form action="/addRoutePoint" method = "POST" class="addDischargePoint" id="addDischargePoint">
